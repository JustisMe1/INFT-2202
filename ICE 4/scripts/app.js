...
let newUser = new userClass.User("Justis", "McGill", "justisme", "jdoe@dcmail.ca", "user1");
...
if ($("#btnRegSubmit")) {
    ...
    $("#btnRegSubmit").click(function (e) {
        ...
        const unvalidUser = new userClass.User(
        ...
        // validate first name
        $("#first-group").children(".errorMessage").html(formValidation.validateFirst(unvalidUser.firstName));
        // validate last name
        $("#last-group").children(".errorMessage").html(formValidation.validateLast(unvalidUser.firstName));
        // validate  username
        $("#username-group").children(".errorMessage").html(formValidation.validateUsername(unvalidUser.username));
        // validate confirm password
        let error = formValidation.validatePassword($("inputPassword").val(), $("inputPassword2").val());
